...
public class VetResourceIntegrationTest {
    ...
    public void createVet() throws Exception {
        ...
        // Create the Vet
        HttpResponse<VetDTO> response = client.toBlocking().exchange(HttpRequest.POST("/api/vets", vetDTO), VetDTO.class);
    ...
    public void getAllVets() throws Exception {
        ...
        List<VetDTO> vets = client.toBlocking().retrieve(HttpRequest.GET("/api/vets?eagerload=true"), Argument.listOf(VetDTO.class));
    ...
    public void getVet() throws Exception {
        // Get the vet
        VetDTO testVet = client.toBlocking().retrieve(HttpRequest.GET("/api/vets/" + vet.getId()), VetDTO.class);
    ...
    public void getNonExistingVet() throws Exception {
        // Get the vet
        @SuppressWarnings("unchecked")
        HttpResponse<VetDTO> response = client.toBlocking().exchange(HttpRequest.GET("/api/vets/" + Long.MAX_VALUE), VetDTO.class);
    ...
    public void updateVet() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<VetDTO> response = client.toBlocking().exchange(HttpRequest.PUT("/api/vets", updatedVetDTO), VetDTO.class);
    ...
    public void updateNonExistingVet() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<VetDTO> response = client.toBlocking().exchange(HttpRequest.PUT("/api/vets", vetDTO), VetDTO.class);
    ...
    public void deleteVet() throws Exception {
        ...
        // Delete the vet
        @SuppressWarnings("unchecked")
        HttpResponse<VetDTO> response = client.toBlocking().exchange(HttpRequest.DELETE("/api/vets/" + vet.getId()), VetDTO.class);
