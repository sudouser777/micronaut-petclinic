...
public class SpecialtyResourceIntegrationTest {
    ...
    public void createSpecialty() throws Exception {
        ...
        HttpResponse<SpecialtyDTO> response = client.toBlocking().exchange(HttpRequest.POST("/api/specialties", specialtyDTO), SpecialtyDTO.class);
    ...
    public void createSpecialtyWithExistingId() throws Exception {
        ...
        HttpResponse<SpecialtyDTO> response = client.toBlocking().exchange(HttpRequest.POST("/api/specialties",
                specialtyDTO), SpecialtyDTO.class);
    ...
    public void getAllSpecialities() throws Exception {
        ...
        List<SpecialtyDTO> specialities = client.toBlocking().retrieve(HttpRequest.GET("/api/specialties?eagerload=true"),
                Argument.listOf(SpecialtyDTO.class));
    ...
    public void getSpecialty() throws Exception {
        // Get the Specialty
        SpecialtyDTO testSpecialty = client.toBlocking().retrieve(HttpRequest.GET("/api/specialties/" + specialty.getId()), SpecialtyDTO.class);
    ...
    public void getNonExistingSpecialty() throws Exception {
        // Get the Specialty
        @SuppressWarnings("unchecked")
        HttpResponse<SpecialtyDTO> response = client.toBlocking().exchange(HttpRequest.GET("/api/specialties/"+ Long.MAX_VALUE), SpecialtyDTO.class);
    ...
    public void updateSpecialty() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<SpecialtyDTO> response = client.toBlocking().exchange(HttpRequest.PUT("/api/specialties", updatedSpecialtyDTO), SpecialtyDTO.class);
    ...
    public void updateNonExistingSpecialty() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<SpecialtyDTO> response = client.toBlocking().exchange(HttpRequest.PUT("/api/specialties", specialtyDTO), SpecialtyDTO.class);
    ...
    public void deleteSpecialty() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<SpecialtyDTO> response = client.toBlocking().exchange(HttpRequest.DELETE("/api/specialties/"+ specialty.getId()), SpecialtyDTO.class);
