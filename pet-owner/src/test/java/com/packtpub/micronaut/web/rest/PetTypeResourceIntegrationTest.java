...
public class PetTypeResourceIntegrationTest {
    ...
    public void createPetType() throws Exception {
        ...
        // Create the PetType
        HttpResponse<PetTypeDTO> response = client.toBlocking().exchange(HttpRequest.POST("/api/pet-types", petTypeDTO), PetTypeDTO.class);
    ...
    public void getAllPetTypes() throws Exception {
        ...
        List<PetTypeDTO> petTypes = client.toBlocking().retrieve(HttpRequest.GET("/api/pet-types?eagerload=true"),
                Argument.listOf(PetTypeDTO.class));
    ...
    public void getPetType() throws Exception {
        ...
        // Get the petType
        PetTypeDTO testPetType = client.toBlocking().retrieve(HttpRequest.GET("/api/pet-types/" + petType.getId()), PetTypeDTO.class);
    ...
    public void getNonExistingPetType() throws Exception {
        // Get the petType
        @SuppressWarnings("unchecked")
        HttpResponse<PetTypeDTO> response = client.toBlocking().exchange(HttpRequest.GET("/api/pet-types/" + Long.MAX_VALUE), PetTypeDTO.class);
    ...
    public void updatePetType() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<PetTypeDTO> response = client.toBlocking().exchange(HttpRequest.PUT("/api/pet-types", updatedPetTypeDTO), PetTypeDTO.class);
    ...
    public void updateNonExistingPetType() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<PetTypeDTO> response = client.toBlocking().exchange(HttpRequest.PUT("/api/pet-types", petTypeDTO), PetTypeDTO.class);
        assertThat(response.status().getCode()).isEqualTo(HttpStatus.INTERNAL_SERVER_ERROR.getCode());
    ...
    public void deletePetType() throws Exception {
        ...
        // Delete the petType
        @SuppressWarnings("unchecked")
        HttpResponse<PetTypeDTO> response = client.toBlocking().exchange(HttpRequest.DELETE("/api/pet-types/" + petType.getId()), PetTypeDTO.class);
