...
public class PetResourceIntegrationTest {
    ...
    public void createPet() throws Exception {
        ...
        // Create the Pet
        HttpResponse<PetDTO> response = client.toBlocking().exchange(HttpRequest.POST("/api/pets", petDTO), PetDTO.class);
        ;
    ...
    public void getAllPets() throws Exception {
        ...
        List<PetDTO> pets = client.toBlocking().retrieve(HttpRequest.GET("/api/pets?eagerload=true"), Argument.listOf(PetDTO.class));
    ...
    public void getPet() throws Exception {
        ...
        // Get the pet
        PetDTO testPet = client.toBlocking().retrieve(HttpRequest.GET("/api/pets/" + pet.getId()), PetDTO.class);
        ;
        assertThat(testPet.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testPet.getBirthDate()).isEqualTo(DEFAULT_BIRTH_DATE);
    ...
    public void getNonExistingPet() throws Exception {
        // Get the pet
        @SuppressWarnings("unchecked")
        HttpResponse<PetDTO> response = client.toBlocking().exchange(HttpRequest.GET("/api/pets/" + Long.MAX_VALUE), PetDTO.class);
    ...
    public void updatePet() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<PetDTO> response = client.toBlocking().exchange(HttpRequest.PUT("/api/pets", updatedPetDTO), PetDTO.class);
    ...
    public void updateNonExistingPet() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<PetDTO> response = client.toBlocking().exchange(HttpRequest.PUT("/api/pets", petDTO), PetDTO.class);
    ...
    public void deletePet() throws Exception {
        ...
        // Delete the pet
        @SuppressWarnings("unchecked")
        HttpResponse<PetDTO> response = client.toBlocking().exchange(HttpRequest.DELETE("/api/pets/" + pet.getId()), PetDTO.class);
