...
public class OwnerResourceIntegrationTest {
    ...
    public void createOwner() throws Exception {
        ...
        HttpResponse<OwnerDTO> response = client.toBlocking().exchange(HttpRequest.POST("/api/owners", ownerDTO), OwnerDTO.class);
    ...
    public void getAllOwners() throws Exception {
        ...
        List<OwnerDTO> owners = client.toBlocking().retrieve(HttpRequest.GET("/api/owners?eagerload=true"), Argument.listOf(OwnerDTO.class));
    ...
    public void getOwner() throws Exception {
        ...
        // Get the owner
        OwnerDTO testOwner = client.toBlocking().retrieve(HttpRequest.GET("/api/owners/" + owner.getId()), OwnerDTO.class);
        // Verify owner
        assertThat(testOwner.getFirstName()).isEqualTo(DEFAULT_FIRST_NAME);
        assertThat(testOwner.getLastName()).isEqualTo(DEFAULT_LAST_NAME);
        assertThat(testOwner.getAddress()).isEqualTo(DEFAULT_ADDRESS);
    ...
    public void getNonExistingOwner() throws Exception {
        // Get the owner
        @SuppressWarnings("unchecked")
        HttpResponse<OwnerDTO> response = client.toBlocking().exchange(HttpRequest.GET("/api/owners/" + Long.MAX_VALUE), OwnerDTO.class);
    ...
    public void updateOwner() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<OwnerDTO> response = client.toBlocking().exchange(HttpRequest.PUT("/api/owners", updatedOwnerDTO), OwnerDTO.class);
    ...
    public void updateNonExistingOwner() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<OwnerDTO> response = client.toBlocking().exchange(HttpRequest.PUT("/api/owners", ownerDTO), OwnerDTO.class);
    ...
    public void deleteOwner() throws Exception {
        ...
        // Delete the owner
        @SuppressWarnings("unchecked")
        HttpResponse<OwnerDTO> response = client.toBlocking().exchange(HttpRequest.DELETE("/api/owners/" + owner.getId()), OwnerDTO.class);
