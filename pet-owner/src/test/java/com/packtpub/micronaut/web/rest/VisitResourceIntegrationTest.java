...
public class VisitResourceIntegrationTest {
    ...
    public void createVisit() throws Exception {
        ...
        // Create the Visit
        HttpResponse<VisitDTO> response = client.toBlocking().exchange(HttpRequest.POST("/api/visits", visitDTO), VisitDTO.class);
    ...
    public void getAllVisits() throws Exception {
        ...
        List<VisitDTO> visits = client.toBlocking().retrieve(HttpRequest.GET("/api/visits?eagerload=true"), Argument.listOf(VisitDTO.class));
    ...
    public void getVisit() throws Exception {
        ...
        // Get the visit
        VisitDTO testVisit = client.toBlocking().retrieve(HttpRequest.GET("/api/visits/" + visit.getId()), VisitDTO.class);
        assertThat(testVisit.getVisitDate()).isEqualTo(DEFAULT_VISIT_DATE);
        assertThat(testVisit.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
    ...
    public void getNonExistingVisit() throws Exception {
        // Get the visit
        @SuppressWarnings("unchecked")
        HttpResponse<VisitDTO> response = client.toBlocking().exchange(HttpRequest.GET("/api/visits/" + Long.MAX_VALUE), VisitDTO.class);
    ...
    public void updateVisit() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<VisitDTO> response = client.toBlocking().exchange(HttpRequest.PUT("/api/visits", updatedVisitDTO), VisitDTO.class);
    ...
    public void updateNonExistingVisit() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<VisitDTO> response = client.toBlocking().exchange(HttpRequest.PUT("/api/visits", visitDTO), VisitDTO.class);
    ...
    public void deleteVisit() throws Exception {
        ...
        // Delete the visit
        @SuppressWarnings("unchecked")
        HttpResponse<VisitDTO> response = client.toBlocking().exchange(HttpRequest.DELETE("/api/visits/" + visit.getId()), VisitDTO.class);
